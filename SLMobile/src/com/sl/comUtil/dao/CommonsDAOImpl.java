...
public class CommonsDAOImpl<T> implements CommonsDAO<T>
{
	private static final Logger log = Logger.getLogger(CommonsDAOImpl.class);
...
//		tx.commit();
	...
	public List findByHQL(String hql)
	{
		...
		{
			log.error("查询错误！" + CommonsDAOImpl.class.getName() + ".findByHQL " + new Date());
			e.printStackTrace();
		}
		return null;
	}
	...
	public List<T> listByHQL(String hql,int page, int max, Object... args)
	{
		...
		{
			log.error("查询错误！" + CommonsDAOImpl.class.getName() + ".listByHQL " + new Date());
			e.printStackTrace();
		}
		return null;
	}
	...
	public int executeHQL(String hql, Object... args)
	{
		...
		{
			log.error("查询错误！" + CommonsDAOImpl.class.getName() + ".executeHQL " + new Date());
			e.printStackTrace();
		}
		return -1;
	}
